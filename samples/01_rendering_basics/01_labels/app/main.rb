...
def tick(args)
  tick_instructions args,
                    'Sample app shows different version of label sizes and alignments. And how to use hashes instead of arrays.'
  ...
  args.outputs.labels << [args.grid.left.shift_right(5), args.grid.bottom.shift_up(30),
                          'This is a label located at the bottom left.']
  args.outputs.labels << [args.grid.right.shift_left(420), args.grid.top.shift_down(5),
                          'This is a label located at the top right.']
  args.outputs.labels << [args.grid.right.shift_left(440), args.grid.bottom.shift_up(30),
                          'This is a label located at the bottom right.']
  ...
  args.outputs.primitives << [690 + 150, 330 - 80, 'Custom font (.primitives Array)', 0, 1, 125, 0, 200, 255,
                              'manaspc.ttf'].label
